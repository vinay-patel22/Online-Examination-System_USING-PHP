...
<div class="row">
<div class="col-lg-6">
<span class="logo" style="font-size:1.5rem; margin-left: 8vh;">Master Your SKILL</span></div>
<?php
...
include_once 'dbConnection.php';
echo '<span class="pull-right top title1" style="margin-right: 13vh; font-size:1.5rem;"><span class="log1"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>&nbsp;&nbsp;&nbsp;&nbsp;Hello,</span> <a href="account.php" class="log log1">'.$name.'</a>&nbsp;|&nbsp;<a href="logout.php?q=account.php" class="log"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span>&nbsp;Signout</button></a></span>';
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
		...
		<li <?php if(@$_GET['q']==9) echo'class="active"'; ?>><a href="https://drive.google.com/drive/folders/1_OsOUje0NjaxrtZUNp_88Qify7ZIm2W6?usp=sharing">Upload Paper</a></li>
